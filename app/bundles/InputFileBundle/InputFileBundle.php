<?php
/**
* Class inputFileBundle responsible for the loading of the bundle for Input File to validate
* @author André Matias <dev.andrematias@gmail.com>
* @version 0.0.1
* @license GPL3
* @package EDValidator
*/
namespace EDValidator\bundles\InputFileBundle;

use EDValidator\bundles\CoreBundle\Abstracts\Bundles;

 class InputFileBundle extends Bundles
 {
 	/**
	...
	*/
 	public function loadController($controller, $method, Array $parammeter)
 	{
 		...
 		if($this->isValidController($controller)){
 			$this->controller = 'EDValidator\bundles\InputFileBundle\Controllers\\'.$controller;
 			...
 			$this->controller = 'EDValidator\bundles\InputFileBundle\Controllers\InputFile';
 		}else{
